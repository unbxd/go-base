...
import (
	...
	"github.com/apoorvprecisely/go-base/base/drivers/zook"
...
//NewConsumer is a new node level consumer
func NewConsumer(
	logger log.Logger,
	path string,
...
//NewWCConsumer is a wild card consumer, i.e allows wildcard in path
func NewWCConsumer(
	logger log.Logger,
	path string,
	options ...ConsumerOption,
